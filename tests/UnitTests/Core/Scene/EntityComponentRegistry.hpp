#ifndef __RAINDROP_TESTS_UNITTESTS_CORE_SCENE_ENTITY_COMPONENT_REGISTRY__HPP__
#define __RAINDROP_TESTS_UNITTESTS_CORE_SCENE_ENTITY_COMPONENT_REGISTRY__HPP__
