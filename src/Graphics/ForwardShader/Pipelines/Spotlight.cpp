...
// 	Spotlight::Spotlight(GraphicsContext& context, VkDescriptorSetLayout descriptorLayout) : _context{context}{
...
// 	void Spotlight::createPipeline(VkDescriptorSetLayout descriptorLayout){
...
// 		builder.setName("forward shading spotlight without shadow");
...
// 		pushConstant.size = sizeof(PushConstants::Spotlight);
...
// 	GraphicsPipeline& Spotlight::pipeline(){
// 		return *_pipeline;
// 	}
// }