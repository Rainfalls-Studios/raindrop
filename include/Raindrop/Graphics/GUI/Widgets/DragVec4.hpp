#ifndef __RAINDROP_GRAPHICS_GUI_WIDGETS_DRAG_VEC4_HPP__
#define __RAINDROP_GRAPHICS_GUI_WIDGETS_DRAG_VEC4_HPP__

#include <Raindrop/Graphics/GUI/Item.hpp>

namespace Raindrop::Graphics::GUI::Widgets{
	class DragVec4 : public Item{
		public:
			DragVec4(tinyxml2::XMLElement* element, Core::Registry::Registry& registry, Core::Event::EventManager& _eventManager);
			virtual ~DragVec4() = default;
			
			virtual bool update() override;

			glm::vec4* _variable = nullptr;
			std::string _label;
			float _speed = 1.f;
			float _min = 0.f;
			float _max = 0.f;
