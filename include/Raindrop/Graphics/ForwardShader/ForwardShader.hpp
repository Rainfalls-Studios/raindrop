...
// 			void renderSuns(VkCommandBuffer commandBuffer, const glm::vec3& cameraPosition, const glm::vec3& cameraDirection);
// 			void renderSunsShadows(VkCommandBuffer commandBuffer, const glm::vec3& cameraPosition, const glm::vec3& cameraDirection);
