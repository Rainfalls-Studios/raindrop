...
namespace Raindrop{
	class Format{
		public:
			...
			enum class PropertiesBits : std::uint64_t{
				NONE = 0,
				SFLOAT = 1ULL << 0,
				SINT = 1ULL << 1,
				SNORM = 1ULL << 2,
			...
			RAINDROP_FLAGS_CLASS(Properties, PropertiesBits);

			enum class FeaturesBits : std::uint64_t{
				NONE = 0,
			...
			RAINDROP_FLAGS_CLASS(Features, FeaturesBits);
